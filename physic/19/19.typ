...
公式:
$
  epsilon = L (d l )/(d t) quad L = Phi/I
$


附加互感公式:
$
  M = Phi_2 / I_1 = Phi_1 /I_2
$
...
题1.对于单匝线圈取自系数的定义式为L=Ф/1，当线圈的几何形状，大小及周围磁介质分布不变
且无铁磁性物质时，若线圈中的电流强度变小，则线圈的自感系数 L 
...
$
  ...
  Phi = N dot B dot S = N dot mu_0 N/l I dot pi R^2= mu_0 N^2/l I dot pi R^2\
  L = Phi / I ==> L =  mu_0 N^2/l  dot pi R^2\
  \
  ==> L prop 1/l ==> L"變小"
$
...
题3.一自感线圈中，电流强度在 0.002s 内均匀地由 10A 增加到12A，此过程中线圈内自感电动势为 400V 则线圈的自感系数为=????

$
  L = Phi/ I

  epsilon = L (d I)/(d t) ==> 400 = L dot (12 - 10)/(0.002)  => L = 0.4  
$
...
题4.一边长为a的正方形线圈放在一根长直导线旁，线圈与直导线共面。其中线圈的中心距长直导线为 $(3 a)/2$ 线圈的一组对边与直导线平行。此时，正方形线圈与直导线的互感系数为()


#align(right)[
  #image("img/14.png",width:30%)
]
